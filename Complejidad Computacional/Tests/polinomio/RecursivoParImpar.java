...
public class RecursivoParImpar {

	@Test
	public void Grado0() {
		double[]coeficientes = {2};
		Polinomio polinomio = new Polinomio(0, coeficientes);
		Assert.assertEquals(2, polinomio.evaluarRecursivaPar(2), 0);
	}
	...
	public void Grado1() {
		...
		Assert.assertEquals(8, polinomio.evaluarRecursivaPar(2), 0);
	}
	...
	public void Grado3() {
		...
		Assert.assertEquals(20, polinomio.evaluarRecursivaPar(2), 0);
	}
	...
	public void Grado6() {
		...
		Assert.assertEquals(-396, polinomio.evaluarRecursivaPar(2), 0);
	}
	...
	public void Grado20() {
		...
		Assert.assertEquals(9217396, polinomio.evaluarRecursivaPar(2), 0);
	}
	...
	public void Grado30() {
		...
		Assert.assertEquals(4.5201913480E9, polinomio.evaluarRecursivaPar(2), 0);
	}
	...
	public void Grado40() {
		...
		Assert.assertEquals(5.560060388724E12, polinomio.evaluarRecursivaPar(2), 0);
	}
	...
	public void Grado50() {
		...
		Assert.assertEquals(1.340367176508788E15, polinomio.evaluarRecursivaPar(2), 0);
	}
}
