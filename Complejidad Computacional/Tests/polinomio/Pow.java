...
public class Pow {
	...
	public void Grado20() {
		...
		Assert.assertEquals(9217396, polinomio.evaluarPow(2), 0);
	}
	...
	public void Grado30() {
		...
		Assert.assertEquals(4.5201913480E9, polinomio.evaluarPow(2), 0);
	}
	...
	public void Grado40() {
		...
		Assert.assertEquals(5.560060388724E12, polinomio.evaluarPow(2), 0);
	}
	...
	public void Grado50() {
		...
		Assert.assertEquals(1.340367176508788E15, polinomio.evaluarPow(2), 0);
	}
